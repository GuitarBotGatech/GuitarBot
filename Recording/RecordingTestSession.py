...
class RecordingTestSession:
    def __init__(self, 
        ...
        # Configure input audio device (prefer 'Focusrite')
        try:
            self._configure_audio_input_device(preferred_substring="Focusrite")
    ...
    def _configure_audio_input_device(self, preferred_substring: str = "Focusrite"):
        ...
        # Try to pick a Focusrite input device automatically
        ...
        print("No 'Focusrite' input found. Available input devices:")
        input_indices = []
        for idx, dev in enumerate(devices):
            try:
                name = dev.get('name', '')
