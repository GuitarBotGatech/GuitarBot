...
class View(tk.Tk):
    def __init__(self):
        ...
        self.song_frame = SongFrame(master=self, width=SCREEN_WIDTH, height=SCREEN_HEIGHT * 0.625)
        ...
        self.song_builder_frame = SongBuilderFrame(master=self, width=SCREEN_WIDTH, height=SCREEN_HEIGHT * 0.125)
