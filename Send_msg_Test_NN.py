...
pluck_message = [
    ...
    [47, .4, 3, 0, 20], [62, .4, 3, 0, 20],
    [47, .5, 2, 0, 20.4], [62, .4, 2, 0, 20.4],
    [47, .4, 3, 0, 21.4], [62, 1, 3, 0, 21.4],

    [47, .4, 3, 0, 23], [62, .4, 3, 0, 23],
    [47, .5, 1, 0, 23.4], [62, 1, 1, 0, 23.4],
    [47, .4, 3, 0, 24.4], [62, .4, 3, 0, 24.4],

    # --- M2: THE POWER HARMONY (Strong/Stable) ---
    # Notes: E string (47) + B string (66)
    [47, .4, 3, 0, 26], [66, .4, 3, 0, 26],
    [47, .5, 6, 0, 26.4], [66, .5, 2, 0, 26.4],
    [47, .4, 3, 0, 27.4], [66, .5, 3, 0, 27.4],

    [47, .4, 3, 0, 29], [66, .4, 3, 0, 29],
    [47, .5, 3, 0, 29.4], [66, .5, 3, 0, 29.4],
    [47, .4, 3, 0, 30.4], [66, .4, 3, 0, 30.4],

    # --- M3 PART 1: WALKING DOWN (Shifted Baseline) ---
    # Notes: E string (45) + B string (60)
    [45, .4, 3, 0, 32], [60, .4, 3, 0, 32],
    [45, .5, 8, 0, 32.4], [60, 1, 2, 0, 32.4],
    [45, .4, 3, 0, 33.4], [60, .4, 3, 0, 33.4],
    [45, 1, 8, 0, 34], [60, 1, 8, 0, 34],

    # --- M3 PART 2: RESOLUTION (Return to Start) ---
    # Notes: E string (47) + B string (62)
    [47, .4, 3, 0, 35], [62, .4, 3, 0, 35],
    [47, .5, 3, 0, 35.4], [62, .5, 3, 0, 35.4],
    [47, .4, 3, 0, 36.4], [62, .4, 3, 0, 36.4],
    [47, .5, 3, 0, 36.8], [62, .5, 3, 0, 36.8],
    [47, .6, 6, 0, 37.3], [62, .6, 8, 0, 37.3]
]
