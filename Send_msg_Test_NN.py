...
pluck_message = [
    ...
    # =================================================================
    # 1st VERSE: Glissandi & Tremolo & Divergent Glissando (78.0 - 99.5) Restrained version
    # E String: Anchor | D String: Anchor/Counter | B String: Melody
    # =================================================================

    # --- BLOCK 1: B7sus4 (78.0 - 81.0) ---
    [47, 0.4, 3, 0, 78.0], [47, 0.4, 3, 0, 79.0], [47, 0.4, 3, 0, 80.0], [47, 0.4, 3, 0, 81.0],
    [57, 0.4, 3, 0, 78.0], [57, 0.6, 4, 1, 79.33], [57, 0.4, 3, 0, 80.66],  # D slides mid-phrase
    [64, 0.7, 8, 1, 78.0], [66, 0.7, 9, 1, 79.0], [64, 0.49, 0, 0, 80.0], [64, 0.4, 0, 0, 81.0],

    # --- BLOCK 2: G Major (82.0 - 85.0) ---
    [43, 0.4, 3, 0, 82.0], [43, 0.4, 3, 0, 83.0], [43, 0.4, 3, 0, 84.0], [43, 0.4, 3, 0, 85.0],
    [50, 0.4, 3, 0, 82.0], [50, 0.4, 3, 0, 83.33], [50, 0.6, 5, 1, 84.66],  # D slides into next block
    [59, 0.4, 0, 0, 82.0], [67, 0.8, 10, 1, 83.0], [59, 0.8, 10, 1, 84.0], [59, 0.4, 0, 0, 85.0],

    # --- BLOCK 3: F#sus4 (86.0 - 89.2) ---
    [42, 0.4, 3, 0, 86.0], [42, 0.4, 3, 0, 87.0], [42, 0.4, 3, 0, 88.0], [42, 0.4, 3, 0, 89.0],
    [54, 0.4, 3, 0, 86.0], [54, 0.4, 3, 0, 86.8], [54, 0.4, 3, 0, 87.6], [54, 0.4, 3, 0, 88.4], [54, 0.4, 3, 0, 89.2],
    [59, 0.4, 0, 0, 86.0], [61, 0.7, 9, 1, 87.0], [59, 0.7, 8, 1, 88.0], [59, 0.4, 0, 0, 89.0],
    # B bending back and forth

    # --- BLOCK 4: E Octave Wall (90.0 - 93.2) ---
    [40, 0.4, 3, 0, 90.0], [40, 0.4, 3, 0, 91.0], [40, 0.4, 3, 0, 92.0], [40, 0.4, 3, 0, 93.0],
    [52, 0.6, 5, 1, 90.0], [52, 0.4, 3, 0, 90.8], [52, 0.4, 3, 0, 91.6], [52, 0.4, 3, 0, 92.4], [52, 0.4, 3, 0, 93.2],
    [64, 0.8, 10, 1, 90.0], [68, 0.8, 10, 1, 91.0], [64, 0.4, 0, 0, 92.0], [66, 0.6, 8, 1, 93.0],
    # B soaring up to Fret 9

    # --- BLOCK 5: Asus2 Resolution (94.0 - 97.0) ---
    [45, 0.4, 3, 0, 94.0], [45, 0.4, 3, 0, 95.0], [45, 0.4, 3, 0, 96.0], [45, 0.4, 3, 0, 97.0],
    [52, 0.4, 3, 0, 94.0], [52, 0.4, 3, 0, 95.0], [52, 0.4, 3, 0, 96.0], [52, 0.4, 3, 0, 97.0],
    [59, 0.4, 0, 0, 94.0], [61, 0.7, 7, 1, 95.0], [59, 0.7, 7, 1, 96.0], [59, 0.4, 0, 0, 97.0],

    # --- VERSE 1 ENDING---
    [45, 0.4, 3, 0, 98.0], [45, 0.4, 3, 0, 99.0], [45, 0.4, 3, 0, 99.5],
    [52, 0.4, 3, 0, 98.0], [52, 0.4, 3, 0, 99.0], [52, 0.4, 3, 0, 99.5],
    [59, 0.4, 3, 0, 98.0], [59, 0.4, 3, 0, 99.0], [59, 0.4, 3, 0, 99.5],
    ...
    # =================================================================
    # Verse 2/Outro Unrestrained version of earlier
    # =================================================================

    # --- BLOCK 1: B7sus4 (141.5 - 144.5) ---
    [47, 0.4, 3, 0, 141.5], [47, 0.4, 3, 0, 142.5], [47, 0.4, 3, 0, 143.5], [47, 0.4, 3, 0, 144.5],
    [57, 0.8, 6, 1, 141.5], [57, 0.8, 7, 1, 142.83], [57, 0.8, 6, 1, 144.16],
    #[64, 0.9, 10, 1, 141.5], [66, 0.9, 10, 1, 142.5], [67, 0.9, 10, 1, 143.5], [64, 0.4, 0, 0, 144.5],

    # --- BLOCK 2: G Major (145.5 - 148.5) ---
    [43, 0.4, 3, 0, 145.5], [43, 0.4, 3, 0, 146.5], [43, 0.4, 3, 0, 147.5], [43, 0.4, 3, 0, 148.5],
    [50, 0.8, 8, 1, 145.5], [50, 0.4, 3, 0, 146.83], [50, 0.8, 9, 1, 148.16],
    #[59, 0.9, 10, 1, 145.5], [67, 0.9, 10, 1, 146.5], [68, 0.9, 10, 1, 147.5], [59, 0.4, 0, 0, 148.5],

    # --- BLOCK 3: F#sus4 (149.5 - 152.7) ---
    [42, 0.4, 3, 0, 149.5], [42, 0.4, 3, 0, 150.5], [42, 0.4, 3, 0, 151.5], [42, 0.4, 3, 0, 152.5],
    [54, 0.8, 7, 1, 149.5], [54, 0.8, 7, 1, 150.3], [54, 0.8, 7, 1, 151.1], [54, 0.8, 7, 1, 151.9], [54, 0.8, 7, 1, 152.7],
    #[59, 0.9, 10, 1, 149.5], [61, 0.9, 10, 1, 150.5], [66, 0.9, 10, 1, 151.5], [59, 0.4, 0, 0, 152.5],

    # --- BLOCK 4: E Octave Wall (153.5 - 156.7) ---
    [40, 0.4, 3, 0, 153.5], [40, 0.4, 3, 0, 154.5], [40, 0.4, 3, 0, 155.5], [40, 0.4, 3, 0, 156.5],
    [52, 0.9, 8, 1, 153.5], [52, 0.9, 8, 1, 154.3], [52, 0.9, 8, 1, 155.1], [52, 0.9, 8, 1, 155.9], [52, 0.4, 3, 0, 156.7],
    #[64, 0.9, 10, 1, 153.5], [68, 0.9, 10, 1, 154.5], [67, 0.9, 10, 1, 155.5], [66, 0.9, 10, 1, 156.5],

    # --- BLOCK 5: Asus2 Resolution (157.5 - 160.5) ---
    ...
    #[59, 0.9, 9, 1, 157.5], [61, 0.9, 9, 1, 158.5], [64, 0.9, 10, 1, 159.5], [59, 0.4, 0, 0, 160.5],

    # --- OUTRO Block 6: Motif  ---
    [45, 0.4, 3, 0, 161.5], [45, 0.4, 3, 0, 162.5], [45, 0.4, 3, 0, 163.0],
    [52, 0.4, 3, 0, 161.5], [52, 0.4, 3, 0, 162.5], [52, 0.4, 3, 0, 163.0],
    #[59, 0.4, 3, 0, 161.5], [59, 0.4, 3, 0, 162.5], [59, 0.4, 3, 0, 163.0]
...
outro_segment = get_pluck_segment(pluck_message, 140.0, 165.0)
# Set part here
pluck_message = outro_segment
