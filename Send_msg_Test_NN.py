...
# print(pluck_message)
pluck_message = [
                   [50, .1, 5, 0, 1, 1], [50, .1, 5, 0, 1, 2], [50, .1, 5, 0, 1, 3], [50, .1, 5, 0, 1, 4], [50, .1, 5, 0, 1, 5], [50, 5, 10, 0, 1, 6]
                   # [50, .5, 1, 0, 2, 1], [50, .5, 1, 0, 2, 1.5],  [50, .5, 1, 0, 2, 2], [50, 1, 1, 0, 2, 3],
                   # [59, .5, 1, 0, 3, 1], [59, .5, 1, 0, 3, 1.5], [59, .5, 1, 0, 3, 2], [59, 1, 1, 0, 3, 3],
                   #
                   # [45, .5, 1, 0, 1, 4], [45, .5, 1, 0, 1, 4.5],  [45, .5, 2, 0, 1, 5], [45, 1, 6, 0, 1, 6],
                   # [52, .5, 1, 0, 2, 4], [52, .5, 1, 0, 2, 4.5],  [52, .5, 2, 0, 1, 5], [52, 1, 6, 0, 1, 6],
                   # [61, .5, 1, 0, 3, 4], [61, .5, 1, 0, 3, 4.5], [61, .5, 6, 0, 3, 5], [61, 1, 10, 0, 3, 6],
                   #
                   #  [42, .5, 1, 0, 1, 7], [42, .5, 1, 0, 1, 7.5],  [42, .5, 2, 0, 1, 8], [42, 1, 6, 0, 1, 9],
                   #  [51, .5, 1, 0, 1, 7], [51, .5, 1, 0, 1, 7.5],  [51, .5, 2, 0, 1, 8], [51, 1, 6, 0, 1, 9],
                   #  [59, .5, 1, 0, 3, 7], [59, .5, 10, 0, 3, 7.5], [59, .5, 6, 0, 3, 8], [59, 1, 10, 0, 3, 9],
                   #
                   # [40, 1, 1, 0, 1, 10], [40, .5, 1, 0, 1, 10.5],  [40, .5, 2, 0, 1, 11], [40, 1, 6, 0, 1, 12],
                   # [50, .5, 1, 0, 1, 10], [50, .5, 1, 0, 1, 10.5],  [50, .5, 2, 0, 1, 11], [50, 1, 6, 0, 1, 12],
                   # [59, .5, 1, 0, 3, 10], [59, .5, 10, 0, 3, 10.5], [59, .5, 6, 0, 3, 11], [59, 1, 10, 0, 3, 12],
#
#                        [40, 1, 1, 0, 1, 1], [40, .5, 1, 0, 1, 1.5],  [40, .5, 2, 0, 1, 2], [40, 1, 6, 0, 1, 3],
    #                    [50, .5, 1, 0, 1, 1.5], [50, .5, 1, 0, 1, 1.5],  [50, .5, 2, 0, 1, 2], [50, 1, 6, 0, 1, 3],
    #                    [59, .5, 1, 0, 3, 2], [59, .5, 10, 0, 3, 1.5], [59, .5, 6, 0, 3, 2], [59, 1, 10, 0, 3, 3],
    #
    #                    [45, .5, 1, 0, 1, 4], [45, .5, 1, 0, 1, 4.5],  [45, .5, 2, 0, 1, 5], [45, 1, 6, 0, 1, 6],
    #                    [52, .5, 1, 0, 1, 4], [52, .5, 1, 0, 1, 4.5],  [52, .5, 2, 0, 1, 5], [52, 1, 6, 0, 1, 6],
    #                    [61, .5, 1, 0, 3, 4], [61, .5, 10, 0, 3, 4.5], [61, .5, 6, 0, 3, 5], [61, 1, 10, 0, 3, 6],
    #
    #                     [42, .5, 1, 0, 1, 7], [42, .5, 1, 0, 1, 7.5],  [42, .5, 2, 0, 1, 8], [42, 1, 6, 0, 1, 9],
    #                     [51, .5, 1, 0, 1, 7], [51, .5, 1, 0, 1, 7.5],  [51, .5, 2, 0, 1, 8], [51, 1, 6, 0, 1, 9],
    #                     [59, .5, 1, 0, 3, 7], [59, .5, 10, 0, 3, 7.5], [59, .5, 6, 0, 3, 8], [59, 1, 10, 0, 3, 9],
