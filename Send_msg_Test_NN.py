...
# pluck_message = [
#                [40, .3, 3, 0, 1], [40, 1, 5, 0, 2], [40, 1, 5, 0, 3.5], [40, .3, 5, 0, 5], [40, 1, 5, 0, 5.5], [40, 1, 5, 0, 6.5], [40, .3, 5, 0, 7.5],
#                [50, .3, 3, 0, 1], [50, 1, 5, 0, 2.5], [50, 1, 5, 0, 3.5], [50, .3, 5, 0, 4.5], [50, 1, 5, 0, 5.5], [50, 1, 5, 0, 6], [50, 1, 5, 0, 6.5], [50, 1, 5, 0, 7], [50, .3, 5, 0, 7.5],
#                [59, .3, 3, 0, 1], [59, 1, 5, 0, 3], [59, 1, 5, 0, 3.5], [59, .3, 5, 0, 4], [59, 1, 5, 0, 5.5], [59, 1, 5, 0, 6], [59, 1, 5, 0, 7], [59, .3, 5, 0, 7.5]
#                 ]
#
pluck_message = [
    # =================================================================
    # LOOP 1: E STRING ONLY (Melody Intro)
    # =================================================================
    # M1, E
    #[40, .4, 10, 0, 1], [40, .4, 10, 0, 2],[40, .4, 10, 0, 3], [40, .4, 10, 0, 4], [40, .4, 10, 0, 5],
    [50, .4, 10, 0, 1], [50, .4, 10, 0, 2],[50, .4, 10, 0, 3], [50, .4, 10, 0, 4], [50, .4, 10, 0, 5],
    #[59, .4, 10, 0, 1], [59, .4, 10, 0, 2],[59, .4, 10, 0, 3], [59, .4, 10, 0, 4], [59, .4, 10, 0, 5],
    # [47, .4, 3, 0, 1], [47, .5, 2, 0, 1.4], [47, .4, 3, 0, 2.4],
    # [47, .4, 3, 0, 4], [47, .5, 1, 0, 4.4], [47, .4, 3, 0, 5.4],
    # # M2, E
    # [47, .4, 3, 0, 7], [47, .5, 6, 0, 7.4], [47, .4, 3, 0, 8.4],
    # [47, .4, 3, 0, 10], [47, .5, 3, 0, 10.4], [47, .4, 3, 0, 11.4],
    # # M3, E
    # [47, .4, 3, 0, 13], [47, .5, 8, 0, 13.4], [47, .4, 3, 0, 14.4], [47, 1, 8, 0, 15],
    # [47, .4, 3, 0, 16], [47, .5, 3, 0, 16.4], [47, .4, 3, 0, 17.4], [47, .5, 3, 0, 17.8], [47, .6, 6, 0, 18.3],
    #
    # # =================================================================
    # # LOOP 2: E AND B STRINGS (Harmony Evolution)
    # # All timestamps shifted by +19.0
    # # =================================================================
    #
    # # --- M1: THE ORIGINAL HARMONY (Folk/Melancholic) ---
    # # Notes: E string (47) + B string (62)
    # [47, .4, 3, 0, 20], [62, .4, 3, 0, 20-10],
    # [47, .5, 2, 0, 20.4], [62, .4, 2, 0, 20.4-10],
    # [47, .4, 3, 0, 21.4], [62, 1, 3, 0, 21.4-10],
    #
    # [47, .4, 3, 0, 23], [62, .4, 3, 0, 23-10],
    # [47, .5, 1, 0, 23.4], [62, 1, 1, 0, 23.4-10],
    # [47, .4, 3, 0, 24.4], [62, .4, 3, 0, 24.4-10],
    #
    # # --- M2: THE POWER HARMONY (Strong/Stable) ---
    # # Notes: E string (47) + B string (66)
    # [47, .4, 3, 0, 26], [66, .4, 3, 0, 26-10],
    # [47, .5, 6, 0, 26.4], [66, .5, 2, 0, 26.4-10],
    # [47, .4, 3, 0, 27.4], [66, .5, 3, 0, 27.4-10],
    #
    # [47, .4, 3, 0, 29], [66, .4, 3, 0, 29-10],
    # [47, .5, 3, 0, 29.4], [66, .5, 3, 0, 29.4-10],
    # [47, .4, 3, 0, 30.4], [66, .4, 3, 0, 30.4-10],
    #
    # # --- M3 PART 1: WALKING DOWN (Shifted Baseline) ---
    # # Notes: E string (45) + B string (60)
    # [45, .4, 3, 0, 32], [60, .4, 3, 0, 32-10],
    # [45, .5, 8, 0, 32.4], [60, 1, 2, 0, 32.4-10],
    # [45, .4, 3, 0, 33.4], [60, .4, 3, 0, 33.4-10],
    # [45, 1, 8, 0, 34], [60, 1, 8, 0, 34-10],
    #
    # # --- M3 PART 2: RESOLUTION (Return to Start) ---
    # # Notes: E string (47) + B string (62)
    # [47, .4, 3, 0, 35], [62, .4, 3, 0, 35-10],
    # [47, .5, 3, 0, 35.4], [62, .5, 3, 0, 35.4-10],
    # [47, .4, 3, 0, 36.4], [62, .4, 3, 0, 36.4-10],
    # [47, .5, 3, 0, 36.8], [62, .5, 3, 0, 36.8-10],
    # [47, .6, 6, 0, 37.3], [62, .6, 8, 0, 37.3-10]
]
