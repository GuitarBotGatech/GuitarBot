...
pluck_message = [
    ...
    # =================================================================
    # E - Loop 1 Intro
    # [45, .4, 3, 0, 1], [45, .5, 2, 0, 1.4], [45, .4, 3, 0, 2.4],
    # [45, .4, 3, 0, 4], [45, .5, 1, 0, 4.4], [45, .4, 3, 0, 5.4],
    # [45, .4, 3, 0, 7], [45, .5, 6, 0, 7.4], [45, .4, 3, 0, 8.4],
    # [45, .4, 3, 0, 10], [45, .5, 3, 0, 10.4], [45, .4, 3, 0, 11.4],
    # [45, .4, 3, 0, 13], [45, .5, 8, 0, 13.4], [45, .4, 3, 0, 14.4], [45, 1, 8, 0, 15],
    # [45, .4, 3, 0, 16], [45, .5, 3, 0, 16.4], [45, .4, 3, 0, 17.4], [45, .5, 3, 0, 17.8], [45, .6, 6, 0, 18.3],
    #
    # # D
    # [52, .4, 3, 0, 1],
    # [52, .4, 3, 0, 4],
    ...
    # # =================================================================
    # # E, Loop 2 Intro
    # [45, .4, 3, 0, 19.0], [45, .5, 2, 0, 19.4], [45, .4, 3, 0, 20.4],
    # [45, .4, 3, 0, 22.0], [45, .5, 1, 0, 22.4], [45, .4, 3, 0, 23.4],
    # [45, .4, 3, 0, 25.0], [45, .5, 6, 0, 25.4], [45, .4, 3, 0, 26.4],
    # [45, .4, 3, 0, 28.0], [45, .5, 3, 0, 28.4], [45, .4, 3, 0, 29.4],
    # [45, .4, 3, 0, 31.0], [45, .5, 8, 0, 31.4], [45, .4, 3, 0, 32.4], [45, 1, 8, 0, 33.0],
    # [45, .4, 3, 0, 34.0], [45, .5, 3, 0, 34.4], [45, .4, 3, 0, 35.4], [45, .5, 3, 0, 35.8], [45, .6, 6, 0, 36.3],
    #
    # # D
    # [52, .4, 3, 0, 19.0], [52, 1, 3, 0, 21.0],
    # [52, .4, 3, 0, 22.0], [52, 1, 6, 0, 24.0],
    # [52, .4, 3, 0, 25.0], [52, 1, 3, 0, 27.0],
    # [52, .4, 3, 0, 28.0], [52, 1, 7, 0, 30.0],
    # [52, .4, 3, 0, 31.0], [52, 1, 3, 0, 33.0],
    # [52, .4, 3, 0, 34.0], [52, 1, 9, 0, 36.0],
    # #
    # # # B
    # [59, 1, 3, 0, 19.0],
    # [59, 2, 4, 0, 22.0],
    # [59, 1, 3, 0, 25.0],
    # [59, 2, 6, 0, 28.0],
    # [59, 1, 8, 0, 31.0], [59, 1, 5, 0, 33.0],
    # [59, 2, 3, 0, 34.0], [59, 1, 10, 0, 33.0],
    # # =================================================================
    # # LOOP 1: Chorus
    # # =================================================================
    [47, 4, 3, 0, 1], [47, 1, 3, 0, 5], [47, .4, 3, 0, 6], [47, 1, 3, 0, 7], [47, .4, 3, 0, 8],
    [57, 3, 3, 0, 2], [57, .4, 3, 0, 5], [57, .4, 3, 0, 8],
    [64, 2, 3, 0, 3], [64, .4, 3, 0, 5], [64, .4, 3, 0, 8],

    [43, .4, 3, 0, 9],[43, 0.4, 3, 0, 10.0], [43, 0.4, 3, 0, 11.0], [43, 0.4, 3, 0, 12.0], [43, 0.4, 3, 0, 13.0], [43, 0.4, 3, 0, 14.0],
    [50, .4, 3, 0, 9], [50, 0.4, 5, 0, 10.0], [50, 0.4, 5, 0, 10.75], [50, 0.4, 5, 0, 11.5], [50, 0.4, 5, 0, 12.25], [50, 0.4, 5, 0, 13.0], [50, 0.4, 5, 0, 13.75],
    [59, .4, 3, 0, 9], [59, 0.7, 8, 0, 10.0], [59, 0.6, 3, 0, 10.8], [59, 0.6, 8, 0, 11.6], [59, 0.7, 6, 0, 12.4], [59, 0.5, 8, 0, 13.2], [59, 0.6, 9, 0, 14.0],

    [43, 0.4, 3, 0, 15.0], [43, 0.4, 3, 0, 16.0], [43, 0.4, 3, 0, 17.0], [43, 0.4, 3, 0, 18.0], [43, 0.4, 3, 0, 19.0],
    [50, 0.4, 3, 0, 15.0], [50, 0.5, 3, 0, 15.8], [50, 0.4, 3, 0, 16.6], [50, 0.5, 5, 0, 17.4], [50, 0.4, 3, 0, 18.2], [50, 0.5, 6, 0, 19.0],
    [59, 0.5, 7, 0, 15.0], [59, 0.4, 3, 0, 15.66], [59, 0.5, 8, 0, 16.33], [59, 0.4, 3, 0, 17.0], [59, 0.5, 9, 0, 17.66], [59, 0.4, 3, 0, 18.33], [59, 0.5, 10, 0, 19.0],

    # # =================================================================
    # # LOOP 2: Chorus
    # # =================================================================

    [43, 0.6, 3, 0, 21.0], [43, 0.6, 3, 0, 23.0], [43, 0.6, 3, 0, 25.0], [43, 0.6, 3, 0, 27.0], [43, 0.6, 3, 0, 29.0],

    # D String (50) - 3-pulse (Interval: 1.5)
    [50, 0.6, 5, 0, 20.5], [50, 0.6, 5, 0, 22.0], [50, 0.6, 5, 0, 23.5], [50, 0.6, 5, 0, 25.0], [50, 0.6, 5, 0, 26.5],
    [50, 0.6, 5, 0, 28.0], [50, 0.6, 5, 0, 29.5],

    # B String (59) - 4-pulse (Interval: 1.0)
    [59, 0.6, 7, 0, 20.0], [59, 0.6, 7, 0, 21.0], [59, 0.6, 8, 0, 22.0], [59, 0.6, 8, 0, 23.0], [59, 0.6, 9, 0, 24.0],
    [59, 0.6, 9, 0, 25.0], [59, 0.6, 10, 0, 26.0], [59, 0.6, 10, 0, 27.0], [59, 0.6, 10, 0, 28.0],
    [59, 0.6, 10, 0, 29.0],

    # === SECTION: ASUS2 FINAL CHORUS BUILD (31.0 - 44.0) ===
    [45, 0.9, 4, 0, 30.0], [45, 0.9, 4, 0, 31.0], [45, 0.9, 4, 0, 32.0], [45, 0.9, 4, 0, 33.0],
    [52, 0.9, 7, 0, 30.0], [52, 0.9, 7, 0, 31.0], [52, 0.9, 7, 0, 32.0], [52, 0.9, 7, 0, 33.0],
    [59, 0.9, 10, 0, 30.0], [59, 0.9, 10, 0, 31.0], [59, 0.9, 10, 0, 32.0], [59, 0.9, 10, 0, 33.0],

    # Long sustained tremolo notes to let the sound ring out before the Verse
    [45, 2.0, 5, 0, 34.0],
    [52, 2.0, 8, 0, 34.0],
    [59, 2.0, 10, 0, 34.0],

    # Final "Staccato" hit to signal the end of the Chorus
