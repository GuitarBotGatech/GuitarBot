...
pluck_message = [
            # M1, E
            # Original
            [40, .4, 3, 0, .75], [40, .4, 2, 0, 1], [40, .4, 3, 0, 1.4], [40, .4, 3, 0, 1.85], [40, .4, 2, 0, 2.1],
            [40, .4, 2, 0, 2.5],

            # Repetition 2 (+2.2s)
            [45, .4, 3, 0, 2.95], [45, .4, 2, 0, 3.2], [45, .4, 3, 0, 3.6], [45, .4, 3, 0, 4.05], [45, .4, 2, 0, 4.3],
            [45, .4, 2, 0, 4.7],

            # Repetition 3 (+4.4s)
            [49, .4, 3, 0, 5.15], [49, .4, 2, 0, 5.4], [49, .4, 3, 0, 5.8], [49, .4, 3, 0, 6.25], [49, .4, 2, 0, 6.5],
            [49, .4, 2, 0, 6.9],

            # Repition 4
            [47, .4, 3, 0, 7.35], [47, .4, 2, 0, 7.6], [47, .4, 3, 0, 8.0], [47, .4, 3, 0, 8.45], [47, .4, 2, 0, 8.7],
            [47, .4, 2, 0, 9.1],



            # M2, E
            #[40, .4, 2, 0, 3.75], [40, .1, 2, 0, 4.5], [45, .1, 6, 0, 5.25], [45, .1, 6, 0, 5.35], [45, .1, 6, 0, 5.45], [45, .1, 6, 0, 5.55], [47, .1, 6, 0, 5.95], [47, .1, 6, 0, 6.05], [47, .1, 6, 0, 6.15], [47, .1, 6, 0, 6.25],

            #[40, .4, 3, 0, 6.65], [40, .4, 2, 0, 7.5], [40, .4, 3, 0, 8.25], [40, .4, 3, 0, 9.0],
            #[40, .4, 2, 0, 9.75], [40, .1, 2, 0, 10.5], [45, .1, 6, 0, 11.25], [45, .1, 6, 0, 11.35], [45, .1, 6, 0, 11.45], [45, .1, 6, 0, 11.55], [47, .5, 7, 0, 11.95],
            # M1, D
            #[57, .4, 3, 0, 1], [57, .5, 2, 0, 1.4], [57, .4, 3, 0, 2.4],
            #[57, .4, 3, 0, 4], [57, .5, 1, 0, 4.4], [57, .4, 3, 0, 5.4],
            # M2, D
            #[40, .4, 3, 0, 7], [40, .5, 8, 0, 7.4], [40, .4, 3, 0, 8.4],
            #[40, .4, 3, 0, 10], [40, .5, 3, 0, 10.4], [40, .4, 3, 0, 11.4],
            # M3, D
            #[40, .4, 3, 0, 13], [40, .5, 8, 0, 13.4], [40, .4, 3, 0, 14.4], [40, 1, 8, 0, 15],
            #[40, .4, 3, 0, 16], [40, .5, 3, 0, 16.4], [40, .4, 3, 0, 17.4], [40, .5, 3, 0, 17.8], [40, .6, 8, 0, 18.3]


            # [59, 20, 1, 0, 1]
            # M1, B
            # Original
            [59, .4, 3, 0, .75], [59, .4, 3, 0, 1], [59, .5, 8, 0, 1.85],
            [59, .4, 2, 0, 2.5],

            # Repetition 2 (+2.2s)
            [61, .1, 3, 0, 2.95], [61, .1, 2, 0, 3.2], [61, .7, 10, 0, 3.6], [61, .1, 3, 0, 4.3], [61, .1, 3, 0, 4.7],

            # Repetition 3 (+4.4s)
            [64, .7, 5, 0, 5.15], [64, .4, 3, 0, 5.8], [64, .4, 2, 0, 6.4],
            [64, .4, 2, 0, 6.8],

            # Repetition 4
            [63, .7, 5, 0, 7.35], [63, .7, 7, 0, 8.45]
