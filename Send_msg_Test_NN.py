...
pluck_message = [
               ...
               #M2, E
               [47, .4, 3, 0, 7], [47, .5, 8, 0, 7.4], [47, .4, 3, 0, 8.4],
               [47, .4, 3, 0, 10], [47, .5, 3, 0, 10.4], [47, .4, 3, 0, 11.4],
               #M3, E
               [47, .4, 3, 0, 13], [47, .5, 8, 0, 13.4], [47, .4, 3, 0, 14.4], [47, 1, 8, 0, 15],
               [47, .4, 3, 0, 16], [47, .5, 3, 0, 16.4], [47, .4, 3, 0, 17.4], [47, .5, 3, 0, 17.8], [47, .6, 8, 0, 18.3],
               ...
               # [59, 20, 1, 0, 1]
               # M1, B
               #[59, .4, 3, 0, 1], [59, .5, 1, 0, 1.4], [59, .4, 3, 0, 2.4],
               #[59, .4, 3, 0, 4], [59, .5, 7, 0, 4.4], [59, .4, 3, 0, 5.4],
               # M2, B
               # [59, .4, 3, 0, 7], [59, .5, 8, 0, 7.4], [59, .4, 3, 0, 8.4],
               # [59, .4, 3, 0, 10], [59, .5, 3, 0, 10.4], [59, .4, 3, 0, 11.4],
               # M3, B
               # [59, .4, 3, 0, 13], [59, .5, 8, 0, 13.4], [59, .4, 3, 0, 14.4], [59, 1, 8, 0, 15],
               # [59, .4, 3, 0, 16], [59, .5, 3, 0, 16.4], [59, .4, 3, 0, 17.4], [59, .5, 3, 0, 17.8], [59, .6, 8, 0, 18.3]

               ]



chords_message = [["On", 20]]
